...
export default class First extends React.Component {
  ...
  render(){
  	  return(
	  // <Input style={{marginTop:18 }} placeholder="昵称" />
	  //    <div style={{ marginBottom: 16,marginTop:18 }}>
	  // 		<Input style={{maxLength:300,height:40}} addonBefore={selectBefore} defaultValue="手机号" />
	  // 	</div>
	  // 	<Input.Password style={{maxLength:300,height:35}} placeholder="密码" />
	      ...
	      <div className="middle">
		      <div className="middlebox">
			      <div className="middleboxone">
				      <img src={Logo} />
					  <h1 lang="zh-CN" class="jsx-1447149503">用作品打动世界</h1>
				  </div>
